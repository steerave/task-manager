...
### Fixed
- Parser no longer eats common words like "sun" (Sunday), "march" etc. from task names — dates are now only parsed from text after "due"/"by"/"before" keywords, preventing false positives like "sun room" → Sunday
